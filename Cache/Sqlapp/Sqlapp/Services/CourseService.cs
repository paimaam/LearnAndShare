...
namespace Sqlapp.Services
{
    public class CourseService
    {
        ...
        {
            string cache_connectionstring = "dileep204.redis.cache.windows.net:6380,password=1h3TwNELWwrdOKy0YA91gJJrM+LeJaM6JKTCyCePthY=,ssl=True,abortConnect=False";
        ...
        public IEnumerable<Course> GetCourses(string _connection_string)
        {
            ...
            {
                string _statement = "SELECT TOP (1000) [CourseID],[CourseName],[Rating] FROM[dbo].[Course]";
